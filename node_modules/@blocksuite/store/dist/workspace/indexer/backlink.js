import { assertExists, diffArray, DisposableGroup, Slot, } from '@blocksuite/global/utils';
...
export class BacklinkIndexer {
    ...
    removeSubpageNode(workspace, subpageId) {
        ...
        subpageNodes.forEach(({ pageId, blockId }) => {
            ...
            if (!block) {
                console.warn(block, 'Failed to remove subpage node from page! block not found! pageId: ' +
