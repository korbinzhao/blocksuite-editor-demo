...
export class Page extends Space {
    constructor({ id, workspace, doc, awarenessStore, idGenerator = uuidv4, }) {
    ...
    addBlock(flavour, blockProps = {}, parent, parentIndex) {
        ...
        this.schema.validate(flavour, parentModel?.flavour, blockProps.children?.map(child => child.flavour));
        ...
        this.transact(() => {
            ...
            const parentModel = typeof parent === 'string' ? this._blockMap.get(parent) : parent;
    ...
    updateBlock(model, props) {
        ...
        this.schema.validate(model.flavour, parent?.flavour, props.children?.map(child => child.flavour));
        ...
        if (yChildren instanceof Y.Array) {
            ...
            yChildren.forEach((id) => {
                ...
                if (Number.isInteger(index)) {
                    ...
                    model.children[index] = this._blockMap.get(id);
                }
            });
        }
        if (model.role === 'root') {
