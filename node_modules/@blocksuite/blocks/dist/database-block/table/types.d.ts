...
export type ColumnType = 'rich-text' | 'select' | 'multi-select' | 'number' | 'checkbox' | 'progress';
...
export type ColumnActionType = 'rename' | 'column-type' | 'duplicate' | 'insert-left' | 'insert-right' | 'move-left' | 'move-right' | 'delete';
export type ColumnAction = ActionMenuItem<ColumnActionType> | Divider;
type DatabaseActionType = ColumnActionType | ToolbarActionType | SwitchViewActionType;
...
export declare const enum SearchState {
    /** show search input */
    SearchInput = "input",
    /** show search icon */
    SearchIcon = "icon",
